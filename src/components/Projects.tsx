...
export default function Projects() {
  ...
  const projects: Project[] = [
    ...
    {
      id: "neurograph-webgpu",
      title: "NeuroGraph WebGPU",
      category: "WebGPU & Neural Architecture",
      description:
        "High-throughput WebGPU tensor compute engine and interactive computation graph visualizer for profiling deep neural networks in real time.",
      details:
        "Engineered with custom WGSL compute shaders, GEMM matrix multiplication pipelines, and multi-threaded Web Workers to render live layer activations, forward-pass latency, and backprop gradients at 120+ FPS.",
      tags: ["WebGPU", "WGSL Shaders", "TypeScript", "Tensor Compute"],
      image: "/images/neurograph-webgpu.jpg",
