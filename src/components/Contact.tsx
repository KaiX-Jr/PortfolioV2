          ...
          >
            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-2.5">
              <a
                ...
                rel="noreferrer"
                onClick={() => playClick()}
                className="text-center py-2.5 rounded-xl bg-theme-sub hover:bg-emerald-500/20 text-theme-primary text-xs font-semibold border transition-all flex items-center justify-center gap-1.5 sm:gap-2 active:scale-95 min-h-[40px]"
              >
              ...
              <a
                href="https://www.linkedin.com/in/swapnoneel07"
                target="_blank"
                rel="noreferrer"
                onClick={() => playClick()}
                className="text-center py-2.5 rounded-xl bg-theme-sub hover:bg-blue-500/20 text-theme-primary text-xs font-semibold border transition-all flex items-center justify-center gap-1.5 sm:gap-2 active:scale-95 min-h-[40px]"
              >
                <svg className="w-4 h-4 fill-current shrink-0" viewBox="0 0 24 24">
              ...
              <a
                ...
                rel="noreferrer"
                onClick={() => playClick()}
                className="text-center py-2.5 rounded-xl bg-theme-sub hover:bg-purple-500/20 text-theme-primary text-xs font-semibold border transition-all flex items-center justify-center gap-1.5 sm:gap-2 active:scale-95 min-h-[40px]"
              >
                <svg className="w-4 h-4 fill-current shrink-0" viewBox="0 0 24 24">
