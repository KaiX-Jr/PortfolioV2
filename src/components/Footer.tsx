      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 flex flex-col md:flex-row justify-between items-center gap-4 sm:gap-6 text-center md:text-left">
        ...
        <div className="flex items-center gap-3 sm:gap-4">
          ...
          <a
            ...
            onClick={() => playClick()}
            onMouseEnter={() => playTap()}
            className="p-2.5 rounded-full bg-slate-100 dark:bg-white/[0.05] hover:bg-blue-500/15 dark:hover:bg-blue-500/20 text-slate-700 dark:text-slate-300 hover:text-blue-600 dark:hover:text-blue-400 transition-all hover:scale-110 active:scale-95 border border-slate-200 dark:border-white/[0.08] min-w-[38px] min-h-[38px] flex items-center justify-center"
            aria-label="LinkedIn Profile (swapnoneel07)"
          >
            <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
