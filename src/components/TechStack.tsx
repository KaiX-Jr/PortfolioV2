...
export default function TechStack() {
  ...
  const stylingTech = ["Tailwind CSS", "Framer Motion", "Anime.js", "Responsive UI", "CSS3 / HTML5"];
  const backendTech = ["Node.js", "Express", "MongoDB", "MySQL", "Machine Learning", "Git & GitHub", "Netlify"];

  return (
    <section className="py-8 sm:py-14 md:py-16 relative scroll-mt-24 sm:scroll-mt-36" id="stack">
      {/* Ambient Glow */}
      <div className="ambient-glow bg-[#10b981] w-[280px] sm:w-[500px] h-[280px] sm:h-[500px] -bottom-20 right-0 opacity-15" />
      ...
      <KokonutBentoGrid className="anime-grid-container gap-4 sm:gap-6">
        ...
        <LiquidGlassCard
          ...
          className="anime-card md:col-span-8 p-4 sm:p-6 md:p-8 flex flex-col justify-between"
        >
          <div>
            <div className="flex items-start justify-between gap-3 mb-4 sm:mb-6">
              <div className="flex items-center gap-2.5 sm:gap-3">
                <div className="p-2 sm:p-3 rounded-2xl bg-emerald-500/15 dark:bg-emerald-500/20 text-emerald-600 dark:text-emerald-300 border border-emerald-500/30 shadow-sm shrink-0">
                  <Code2 size={18} className="sm:w-6 sm:h-6" />
                </div>
                <div>
            ...
            <div className="flex flex-wrap gap-1.5 sm:gap-2.5 mb-4 sm:mb-6">
              {coreTech.map((tech) => (
                <span
                  ...
                  className="bg-theme-sub hover:bg-emerald-500/20 text-theme-primary px-2.5 sm:px-4 py-1 sm:py-2 rounded-full text-[11px] sm:text-xs font-semibold border transition-all hover:scale-105 active:scale-95"
                >
                  {tech}
                </span>
              ))}
        ...
        <LiquidGlassCard
          ...
          className="anime-card md:col-span-4 p-4 sm:p-6 md:p-8 flex flex-col justify-between"
        >
          <div>
            <div className="flex items-start justify-between gap-3 mb-4 sm:mb-6">
              <div className="flex items-center gap-2.5 sm:gap-3">
                <div className="p-2 sm:p-3 rounded-2xl bg-teal-500/15 dark:bg-cyan-500/20 text-teal-600 dark:text-cyan-300 border border-teal-500/30 shadow-sm shrink-0">
            ...
            <div className="flex flex-wrap gap-1.5 sm:gap-2 mb-4 sm:mb-6">
              {stylingTech.map((tech) => (
                <span
                  key={tech}
                  onMouseEnter={() => playTap()}
                  className="bg-theme-sub hover:bg-teal-500/20 text-theme-primary px-2.5 sm:px-3.5 py-1 sm:py-1.5 rounded-full text-[11px] sm:text-xs font-semibold border transition-all hover:scale-105 active:scale-95"
                >
                  {tech}
                </span>
              ))}
        ...
        <LiquidGlassCard
          glowColor="#6366f1"
          refractionColor="#10b981"
          className="anime-card md:col-span-12 p-4 sm:p-6 md:p-8"
        >
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 sm:gap-6">
            <div className="flex-1 w-full">
              <div className="flex items-start sm:items-center justify-between gap-3 mb-3 sm:mb-4">
                <div className="flex items-center gap-2.5 sm:gap-3">
                  <div className="p-2 sm:p-3 rounded-2xl bg-indigo-500/15 dark:bg-purple-500/20 text-indigo-600 dark:text-purple-300 border border-indigo-500/30 shadow-sm shrink-0">
                    <Database size={18} className="sm:w-6 sm:h-6" />
                  </div>
                  <div>
                    <h3 className="text-base sm:text-xl md:text-2xl font-bold text-theme-primary">
              ...
              <div className="flex flex-wrap gap-1.5 sm:gap-2.5">
                {backendTech.map((tech) => (
                  <span
                    key={tech}
                    onMouseEnter={() => playTap()}
                    className="bg-theme-sub hover:bg-indigo-500/20 text-theme-primary px-2.5 sm:px-4 py-1 sm:py-2 rounded-full text-[11px] sm:text-xs font-semibold border transition-all hover:scale-105 active:scale-95"
                  >
                    {tech}
                  </span>
                ))}
            ...
            <div className="bg-theme-sub p-3.5 sm:p-5 rounded-2xl border max-w-sm w-full backdrop-blur-md shrink-0">
